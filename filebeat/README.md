...
One of the problem that we faced is how to push a high number of files generated by a system (i.e jenkins in our case) into elasticseach. The number of file can reach more than 10000 files which are not necessarily big.
